...
func (t Training) meanSpeed() float64 {
	// вставьте ваш код ниже
	meanSpeed := t.LenStep * float64(t.Action) / t.Duration.Hours()
...
func (r Running) Calories() float64 {
	...
	calories := ((float64(CaloriesMeanSpeedMultiplier)*meanSpeed + CaloriesMeanSpeedShift) * r.Weight / float64(MInKm) * r.Duration.Hours() * MinInHours)
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	meanSpeed := math.Pow(w.meanSpeed(), 2)
...
func (s Swimming) Calories() float64 {
	...
	calories := (meanSpeed + SwimmingCaloriesMeanSpeedShift) * float64(SwimmingCaloriesWeightMultiplier) * s.Weight * s.Duration.Hours()
